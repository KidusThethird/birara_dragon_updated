...
export default function RoofList() {
  ...
  const products = [
    { name: "Colorful Stone Coated Metal", image: "/products/roof/194.jpeg" },
    { name: "PVC Roof Tiles", image: "/products/roof/195.jpeg" },
    { name: "Asphalt Shingles", image: "/products/roof/196.jpeg" },
  ];
        ...
        <main className="w-full md:w-3/4 p-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {currentProducts.map((product) => {
              ...
              const imageNumber =
                product.image.match(/\/products\/roof\/(\d+)\.jpeg/)?.[1] ||
                "0";
