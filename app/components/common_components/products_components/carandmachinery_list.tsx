...
export default function CarsAndMachineryList() {
  ...
  // New products array with only cars, machinery, and electronics items
  const products = [
    ...
    { name: "Home & Office Electronics", image: "/products/car/109.jpeg" },
    { name: "Industrial Equipment", image: "/products/car/110.jpeg" },
      ...
      <div className="px-4 py-2 bg-gray-100">
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/cars-machinery-electronics">
        ...
        <main className="w-full md:w-3/4 p-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {currentProducts.map((product) => {
              // Extract the number from the image path (e.g., "/products/car/106.jpeg" -> "106")
              const imageNumber =
