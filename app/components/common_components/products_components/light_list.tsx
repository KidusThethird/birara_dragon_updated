...
export default function LightList() {
  ...
  const products = [
    { name: "Container House", image: "/products/light/190.jpeg" },
    { name: "Space Capsule House", image: "/products/light/191.jpeg" },
  ];
      ...
      <div className="px-4 py-2 bg-gray-100">
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="">Light Steel House</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>
        ...
        <main className="w-full md:w-3/4 p-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {currentProducts.map((product) => {
              ...
              const imageNumber =
                product.image.match(/\/products\/light\/(\d+)\.jpeg/)?.[1] ||
                "0";
