...
export default function CoatingList() {
  ...
  const products = [
    { name: "Floor Paint", image: "/products/coating/174.jpeg" },
    { name: "Waterproof Paint", image: "/products/coating/175.jpeg" },
    { name: "Interior Wall Paint", image: "/products/coating/176.jpeg" },
    { name: "Exterior Wall Paint", image: "/products/coating/177.jpeg" },
  ];
      ...
      <div className="px-4 py-2 bg-gray-100">
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="">Coating</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>
        ...
        <main className="w-full md:w-3/4 p-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {currentProducts.map((product) => {
              ...
              const imageNumber =
                product.image.match(/\/products\/coating\/(\d+)\.jpeg/)?.[1] ||
                "0";
