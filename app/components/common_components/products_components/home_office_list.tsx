...
export default function HomeOfficeList() {
  ...
  const products = [
    ...
    { name: "Construction Materials", image: "/products/home/119.jpeg" },
    { name: "Home Decor & Lighting", image: "/products/home/120.jpeg" },
    {
      name: "Commercial Fixtures & Displays",
      image: "/products/home/121.jpeg",
    },
  ];
