...
export default function StairsList() {
  ...
  const products = [
    { name: "Stone Staircase", image: "/products/stairs/197.jpeg" },
    { name: "Glass Staircase", image: "/products/stairs/198.jpeg" },
    { name: "Metal Staircase", image: "/products/stairs/199.jpeg" },
    { name: "Wooden Staircase", image: "/products/stairs/200.jpeg" },
  ];
        ...
        <main className="w-full md:w-3/4 p-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {currentProducts.map((product) => {
              ...
              const imageNumber =
                product.image.match(/\/products\/stairs\/(\d+)\.jpeg/)?.[1] ||
                "0";
