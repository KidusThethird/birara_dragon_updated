...
export default function BusinessList() {
  ...
  // Updated menu data to match ProductsPage.tsx
  const menuItems = [
    {
      category: "Furniture",
      subItems: [
  ...
  // Products array with business consulting items
  const products = [
    { name: "Market Entry Consulting", image: "/products/business/127.jpeg" },
    {
      name: "Supplier & Vendor Sourcing",
      image: "/products/business/128.jpeg",
    },
    { name: "Supply Chain Management", image: "/products/business/129.jpeg" },
    { name: "Quality Control Services", image: "/products/business/130.jpeg" },
    { name: "Export & Import Support", image: "/products/business/131.jpeg" },
  ];
      ...
      <div className="px-4 py-2 bg-gray-100">
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/business-consulting-and-sourcing-services">
        ...
        <main className="w-full md:w-3/4 p-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {currentProducts.map((product) => {
              // Extract the number from the image path (e.g., "/products/business/127.jpeg" -> "127")
              const imageNumber =
                product.image.match(/\/products\/business\/(\d+)\.jpeg/)?.[1] ||
                "0";
