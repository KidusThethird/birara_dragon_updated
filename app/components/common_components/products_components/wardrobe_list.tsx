...
export default function WardrobeList() {
  ...
  const products = [
    { name: "Wardrobe Accessories", image: "/products/wardrobe/192.jpeg" },
    {
      name: "Modern wardrobe walkin closet",
      image: "/products/wardrobe/193.jpeg",
    },
  ];
      ...
      <div className="px-4 py-2 bg-gray-100">
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="">Wardrobe Walkin Closet</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>
        ...
        <main className="w-full md:w-3/4 p-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {currentProducts.map((product) => {
              ...
              const imageNumber =
                product.image.match(/\/products\/wardrobe\/(\d+)\.jpeg/)?.[1] ||
                "0";
