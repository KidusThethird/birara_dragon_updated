...
export default function CurtainList() {
  ...
  const products = [
    { name: "Track System / Accessories", image: "/products/curtain/178.jpeg" },
    { name: "Blinds", image: "/products/curtain/179.jpeg" },
    { name: "Curtain Fabric", image: "/products/curtain/180.jpeg" },
  ];
      ...
      <div className="px-4 py-2 bg-gray-100">
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="">Curtain Fabric</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>
        ...
        <main className="w-full md:w-3/4 p-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {currentProducts.map((product) => {
              ...
              const imageNumber =
                product.image.match(/\/products\/curtain\/(\d+)\.jpeg/)?.[1] ||
                "0";
