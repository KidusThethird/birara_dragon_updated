...
export default function FashionList() {
  ...
  // New products array with only fashion items
  const products = [
    { name: "Women’s Fashion", image: "/products/fashion/112.jpeg" },
    { name: "Men’s Fashion", image: "/products/fashion/113.jpeg" },
    { name: "Accessories & Footwear", image: "/products/fashion/114.jpeg" },
    {
      name: "Human Hair Extensions & Wigs",
      image: "/products/fashion/115.jpeg",
    },
    { name: "Children’s Apparel", image: "/products/fashion/116.jpeg" },
  ];
      ...
      <div className="px-4 py-2 bg-gray-100">
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/fashion-apparel">
        ...
        <main className="w-full md:w-3/4 p-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {currentProducts.map((product) => {
              // Extract the number from the image path (e.g., "/products/fashion/112.jpeg" -> "112")
              const imageNumber =
                product.image.match(/\/products\/fashion\/(\d+)\.jpeg/)?.[1] ||
                "0";
