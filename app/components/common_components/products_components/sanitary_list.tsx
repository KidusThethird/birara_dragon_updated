...
export default function SanitaryList() {
  ...
  const products = [
    { name: "Sauna Room", image: "/products/sanitary/165.jpeg" },
    { name: "Shower Flooring", image: "/products/sanitary/166.jpeg" },
    { name: "Hardware Accessories", image: "/products/sanitary/167.jpeg" },
    { name: "Massage Bathtub", image: "/products/sanitary/168.jpeg" },
    { name: "Bathtub", image: "/products/sanitary/169.jpeg" },
    { name: "Shower Room", image: "/products/sanitary/170.jpeg" },
    { name: "Toilet", image: "/products/sanitary/171.jpeg" },
    { name: "Swimming pool", image: "/products/sanitary/172.jpeg" },
    { name: "Wash Basin", image: "/products/sanitary/173.jpeg" },
  ];
        ...
        <main className="w-full md:w-3/4 p-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {currentProducts.map((product) => {
              ...
              const imageNumber =
                product.image.match(/\/products\/sanitary\/(\d+)\.jpeg/)?.[1] ||
                "0";
