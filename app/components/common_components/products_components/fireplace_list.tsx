...
export default function FirePlaceList() {
  ...
  const products = [
    { name: "Water Vapor Fireplace", image: "/products/fireplace/181.jpeg" },

    { name: "Electric Fireplace", image: "/products/fireplace/182.jpeg" },

    { name: "Wood-Burning Fireplace", image: "/products/fireplace/183.jpeg" },
  ];
      ...
      <div className="px-4 py-2 bg-gray-100">
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="">Fire Place</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>
