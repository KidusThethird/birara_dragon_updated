...
export default function WallList() {
  ...
  const products = [
    { name: "Foam Ceramics", image: "/products/wall/135.jpeg" },
    { name: "Solid Wood Wall Panels", image: "/products/wall/136.jpeg" },
    { name: "Aluminium/ Satinless Stell", image: "/products/wall/137.jpeg" },
    { name: "Soft Porcelain Flexible Tiles", image: "/products/wall/138.jpeg" },
    { name: "Wall Panel", image: "/products/wall/139.jpeg" },
  ];
        ...
        <main className="w-full md:w-3/4 p-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {currentProducts.map((product) => {
              ...
              const imageNumber =
                product.image.match(/\/products\/wall\/(\d+)\.jpeg/)?.[1] ||
                "0";
