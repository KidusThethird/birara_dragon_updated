...
export default function ArcList() {
  ...
  const products = [
    { name: "Building structure", image: "/products/arc/184.jpeg" },
    { name: "Transportation Buildings", image: "/products/arc/185.jpeg" },
    { name: "Industrial Buildings", image: "/products/arc/186.jpeg" },
    { name: "Commercial Buildings", image: "/products/arc/187.jpeg" },
    { name: "Residential Buildings", image: "/products/arc/188.jpeg" },
    { name: "Greening Design", image: "/products/arc/189.jpeg" },
  ];
      ...
      <div className="px-4 py-2 bg-gray-100">
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="">Architectural Design</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>
        ...
        <main className="w-full md:w-3/4 p-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {currentProducts.map((product) => {
              ...
              const imageNumber =
                product.image.match(/\/products\/arc\/(\d+)\.jpeg/)?.[1] || "0";
