...
export default function HomeApplianceList() {
  ...
  const products = [
    { name: "Air Conditioner", image: "/products/homeappliance/140.jpeg" },
    { name: "Televidion", image: "/products/homeappliance/141.jpeg" },
    { name: "Oven", image: "/products/homeappliance/142.jpeg" },
    { name: "Dish Wahser", image: "/products/homeappliance/143.jpeg" },
    { name: "Refrigerator", image: "/products/homeappliance/144.jpeg" },
    { name: "Gas Stove", image: "/products/homeappliance/145.jpeg" },
  ];
      ...
      <div className="px-4 py-2 bg-gray-100">
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="">Home Appliance</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>
