...
export default function ElevatorList() {
  ...
  const products = [
    { name: "Elevating Work Platform", image: "/products/elevator/213.jpeg" },
    { name: "Panoramic Elevator", image: "/products/elevator/214.jpeg" },

    { name: "Escalator", image: "/products/elevator/215.jpeg" },

    {
      name: "Home Elevator / Villa Elevator",
      image: "/products/elevator/216.jpeg",
    },

    { name: "Hospital Elevator", image: "/products/elevator/217.jpeg" },
  ];
      ...
      <div className="px-4 py-2 bg-gray-100">
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="">Elevator</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>
        ...
        <main className="w-full md:w-3/4 p-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {currentProducts.map((product) => {
              ...
              const imageNumber =
                product.image.match(/\/products\/elevator\/(\d+)\.jpeg/)?.[1] ||
                "0";
