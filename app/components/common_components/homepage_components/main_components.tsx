...
const items = [
  ...
  },
  {
    ...
    text: "Modern Doors",
    link: "/products/modern-doors",
  },
  {
    id: 28,
    image: "/products/otherproducts/elevator.jpg",
    text: "Elevator",
    link: "/products/elevator",
  },
